const vulnerabilities = {
  'low_mobility': new Vulnerability('Low Mobility', 'Low ability to reposition during fights and react to flankers, must clear flanks to win.'),
  ...
  'no_anti_dive_poke': new Vulnerability('No Anti Dive', 'Vulneralbe to Dive heros.'),
  ...
  'low_mitigation': new Vulnerability('Low Damage Mitigation', 'Low Damage Mitigation, this team lacks abilities to negate/deny damage, abilities, and enemy healing.'),
}
