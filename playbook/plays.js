...
playbook.add(new Play(
  ...
  [
    `Coordinate targets.`,
    `Target: Low HP pools (squishy).`,
    `Target: Isolated from sustain/antidive heros, like Cassidy.`,
    `Target: Without Line-of-Sight to ranged heros, like Soldier 76.`,
    `Target: Anti-dive abilities already comitted or not present, like Ana without nade/sleep.`,
